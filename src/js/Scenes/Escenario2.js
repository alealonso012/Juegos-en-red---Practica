...
//FIN COSAS PERSONAJE
    ...
    create() {
        ...
        this.suelo2 = this.add.rectangle(96, 384, 144, 32, 0xffffff, 0.0).setOrigin(0)
        this.physics.add.existing(this.suelo2)
        this.suelo2.body.setImmovable(true)
        this.suelo2.body.allowGravity = false

        this.suelo3 = this.add.rectangle((800-(144*2)), 368, 160, 32, 0xffffff, 0.0).setOrigin(0)
        this.physics.add.existing(this.suelo3)
        this.suelo3.body.setImmovable(true)
        this.suelo3.body.allowGravity = false

        this.pared = this.add.rectangle((800-160), 512-144, 32, 144, 0xffffff, 0.0).setOrigin(0)
